...
#This script is intended for use with the Micro-AV MuSHR car. Written and maintained by Jonathan Young. Adapted from https://raw.githubusercontent.com/prl-mushr/mushr/master/mushr_utils/install_scripts/mushr_install_stack.sh 
...
# For wireless static IP connection
...
# Install librealsense. Following commands from
